/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: c7041957dc075fa5bbbc57c63bae860f)
...
interface __BaseEnv_Env {
	...
	POUCH_DATABASES: DurableObjectNamespace /* PouchDatabase from obsidian-sync-dev */ | DurableObjectNamespace /* PouchDatabase from obsidian-sync */;
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		POUCH_DATABASES: DurableObjectNamespace /* PouchDatabase from obsidian-sync-dev */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VAULT_DATABASE" | "MCP_PUBLIC_BASE_URL" | "MCP_WRITES_ENABLED" | "GITHUB_ALLOWED_USER_IDS" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
