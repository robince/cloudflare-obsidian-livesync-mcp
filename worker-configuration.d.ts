/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 5ba4c7204c9805597c91979e192c53f6)
...
interface __BaseEnv_Env {
	...
	BACKUP_MONTHLY: string;
	COUCHDB_PASSWORD: string;
	POUCH_DATABASES: DurableObjectNamespace<import("./src/index").PouchDatabase>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PouchDatabase";
	}
	interface DevEnv {
		BACKUP_BUCKET: R2Bucket;
		COUCHDB_USERNAME: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COUCHDB_USERNAME" | "CORS_ORIGINS" | "BACKUP_DATABASE" | "BACKUP_ENABLED" | "BACKUP_DAILY" | "BACKUP_WEEKLY" | "BACKUP_MONTHLY" | "COUCHDB_PASSWORD">> {}
}
